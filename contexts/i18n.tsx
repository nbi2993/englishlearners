...
const translations = {
  en: {
    ...
    signUpDescription: 'Join to start your learning journey.',
    fullName: 'Full Name',
    enterYourName: 'Enter your full name',
    confirmPassword: 'Confirm Password',
    confirmPasswordPlaceholder: 'Re-type your password',
    passwordsDoNotMatch: 'Passwords do not match.',
    passwordShouldBeAtLeast8: 'Password should be at least 8 characters long.',
    ...
    guest: 'Guest',
    roleSelectionDescription: 'To tailor your experience, please tell us who you are.',
    iAmAStudent: 'I am a Student',
    studentRoleDescription: 'Access lessons, track your progress, and improve your English skills.',
    iAmATeacher: 'I am a Teacher',
    teacherRoleDescription: 'Manage your classes, assign homework, and monitor your students\' performance.',
  ...
  vi: {
    ...
    SecondaryProgram: 'Chương trình Trung học',
    // Sidebar
    home: 'Trang chủ',
    ...
    signUpDescription: 'Tham gia để bắt đầu hành trình học tập của bạn.',
    fullName: 'Họ và tên',
    enterYourName: 'Nhập họ và tên của bạn',
    confirmPassword: 'Xác nhận mật khẩu',
    confirmPasswordPlaceholder: 'Nhập lại mật khẩu của bạn',
    passwordsDoNotMatch: 'Mật khẩu không khớp.',
    passwordShouldBeAtLeast8: 'Mật khẩu phải có ít nhất 8 ký tự.',
    ...
    invalidEmailOrPassword: 'Email hoặc mật khẩu không hợp lệ. Vui lòng thử lại.',
    ...
    // Role Selection Page
    oneLastStep: 'Một bước cuối cùng',
    guest: 'Khách',
    roleSelectionDescription: 'Để điều chỉnh trải nghiệm của bạn, vui lòng cho chúng tôi biết bạn là ai.',
    iAmAStudent: 'Tôi là học sinh',
    studentRoleDescription: 'Truy cập bài học, theo dõi tiến trình và cải thiện kỹ năng tiếng Anh của bạn.',
    iAmATeacher: 'Tôi là giáo viên',
    teacherRoleDescription: 'Quản lý lớp học, giao bài tập và theo dõi hiệu suất của học sinh.',
    savingSelection: 'Đang lưu lựa chọn',
