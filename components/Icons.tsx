...
export const RocketLaunchIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a17.96 17.96 0 01-12.134-1.37m12.134 1.37l-5.84 7.38m-5.84-7.38l5.84-7.38m5.84 7.38v4.82" />
    </svg>
);
...
export const YoutubeIcon: React.FC<IconProps> = (props) => (
    <svg {...props} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2ZM18,12.75A4,4,0,0,1,14.25,16H9.75A4,4,0,0,1,6,12.75v-1.5A4,4,0,0,1,9.75,8h4.5A4,4,0,0,1,18,11.25Zm-5.25-2a.75.75,0,0,0-.75.75v3a.75.75,0,0,0,1.28.53l2.25-1.5a.75.75,0,0,0,0-1.06l-2.25-1.5A.75.75,0,0,0,12.75,10.75Z"/>
    </svg>
);

export const FacebookIcon: React.FC<IconProps> = (props) => (
    <svg {...props} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2.04C6.5 2.04 2.04 6.5 2.04 12c0 4.97 3.66 9.12 8.44 9.88v-7H7.88V12h2.6V9.67c0-2.58 1.54-3.99 3.88-3.99 1.1 0 2.24.2 2.24.2v2.45h-1.29c-1.25 0-1.66.78-1.66 1.59V12h2.78l-.45 2.88h-2.33v7C18.3 21.12 21.96 16.97 21.96 12c0-5.5-4.46-9.96-9.96-9.96z"/>
    </svg>
);
...
export const BeakerIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.28a2 2 0 00-1.806 1.806L4.25 19.5a2 2 0 001.806 1.806L7.5 21.75a2 2 0 001.806-1.806L11.75 14.5a2 2 0 00-1.806-1.806L8.5 12.25v-2.25a2 2 0 012-2h3a2 2 0 012 2v2.25l-1.453.29a2 2 0 00-1.806 1.806l.074 1.442z" />
    </svg>
);

export const TranslateIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m4 13-4-4M19 17v-2a4 4 0 00-4-4H9.528a1 1 0 00-.904.568l-1.928 4.82a1 1 0 00.904 1.432H15a4 4 0 004-4v-1z" />
  </svg>
);
...
export const RefreshIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M20 4l-4 4M4 20l4-4M12 4v2a6 6 0 010 12v2" />
    </svg>
);
